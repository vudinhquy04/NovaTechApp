      ...
      >
        ...
        <View style={styles.bannerContainer}>
          <View style={styles.banner}>
            <View style={styles.bannerContent}>
              ...
              <Image
                source={{ uri: 'https://cdn.tgdd.vn/2023/10/banner/720-220-720x220-70.png' }}
        ...
        >
          {[
            ...
            { name: 'Điện thoại', icon: 'phone-portrait-outline', slug: 'phone' },
            ...
            <TouchableOpacity 
              ...
              onPress={() => navigation.navigate('Categories', { category: cat.slug })}
            >
        ...
        {/* Hot Products */}
        {hotProducts.length > 0 && renderSection('🔥 SẢN PHẨM HOT', hotProducts, true)}

        {/* Featured Products */}
        {featuredProducts.length > 0 && renderSection('⭐ SẢN PHẨM NỔI BẬT', featuredProducts, true)}
